...
#[AsMessageHandler]
class OrderUpgradeLicenseCommandHandler
{
    ...
    public function __invoke(OrderUpgradeLicenseCommand $command): string
    {
        $order = $this->licenseOrderFactory->createFromOrderRequest(
            $command->getRequest(), LicenseOrderTypeEnum::UPGRADE_LICENSE->value
        );
